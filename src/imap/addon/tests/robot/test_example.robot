...
#
#  $ bin/test -s imap.addon -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src imap.addon.testing.IMAP_ADDON_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/imap/addon/tests/robot/test_example.robot
#
